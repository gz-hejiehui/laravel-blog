...
<body>
      ...
      <div class="col-md-8">
        ...
        <article class="blog-post">
          ...
          <p>This is some additional paragraph placeholder content. It has been written to fill the available space and
            ...
            demonstration flowing, so be on the lookout for this <bvtag
              class="memorize_new_word bv_getbootstrap_com bv_browserName_google_chrome  burning_vocabulary  _id_1675044768336">
              exact</bvtag> same string of text.</p>
          <h2>Blockquotes</h2>
          ...
          <h3>Example lists</h3>
          <p>This is some additional paragraph placeholder content. It's a <bvtag
              class="memorize_new_word bv_getbootstrap_com bv_browserName_google_chrome  burning_vocabulary  _id_1672976311381">
              slightly</bvtag> shorter version of the other highly repetitive body text used throughout. This is an
            example unordered list:</p>
          <ul>
  ...
  <main>
    <div class="container">
      <div class="p-4 p-md-5 mb-4 mt-5 text-primary rounded bg-light">
        <div class="col-md-6 px-0">
          <h1 class="display-4 fst-italic">Title of a longer featured blog post</h1>
